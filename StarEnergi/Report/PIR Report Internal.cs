namespace StarEnergi.Reporting
{
    ...
    /// </summary>
    public partial class PIR_Report_Internal : Telerik.Reporting.Report
    {
        public PIR_Report_Internal()
        {
            //

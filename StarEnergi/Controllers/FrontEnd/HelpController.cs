    ...
    public class HelpController : Controller
    {
        ...
        public ActionResult GetContent(string type)
        {
            ...
            if (type == "Fracas_Event_Log")
                ...
                file = Server.MapPath(Url.Content("~/Content/Help/Incident Report.pdf"));
            else if (type == "Incident_Investigation_Report")
                file = Server.MapPath(Url.Content("~/Content/Help/Incident Investigation Report.pdf"));
            else if (type == "Injury_Report")
                file = Server.MapPath(Url.Content("~/Content/Help/Injury Report.pdf"));
            else if(type == "Audit")
                file = Server.MapPath(Url.Content("~/Content/Help/SHE Audit.pdf"));
            else if (type == "Observation_Form")
                file = Server.MapPath(Url.Content("~/Content/Help/SHE Observation.pdf"));
                ...
                file = Server.MapPath(Url.Content("~/Content/Help/Root Cause Analysis.pdf"));
            else if (type == "PIR")
